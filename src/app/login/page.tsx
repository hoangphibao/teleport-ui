  ...
  return (
    <section className="w-full h-screen flex items-center justify-center">
      <form
        ...
        border border-solid border-[#242424]  rounded"
      ...
      >
        ...
        <div className="flex w-full">
          <input
            ...
            className="w-full h-8 border border-solid border-[#242424] py-1 px-2.5 rounded-l  text-[13px]"
            name="password"
          />
          <button
            className="w-2/12	border-y border-r border-solid border-[#242424]  rounded-r 
        ...
        <div className="w-full h-10	relative flex items-center justify-center">
          ...
          <p className="w-8	h-6  z-10 flex items-center justify-center">or</p>
        </div>

        <button
          className="flex py-2 px-4 text-sm	align-middle items-center rounded text-999  
          border border-solid border-[#242424] transition duration-150  gap-3"
          onClick={(e) => {
            e.preventDefault();
            signIn("google")
          }}>
